...
> - 小程序开发人员明确了标注是2倍屏后， 设计wcss样式的时候，要把 数值x2 
...
|         密度类型         | 分辨率（px） | 屏幕密度（dpi） | 换算（px/dp） | 分辨率（dp） |
| ------------------------ | ------------ | --------------- | ------------- | ------------ |
...
|    密度类型    |     分辨率（px）      | 屏幕密度（dpi） | 换算（px/pt） | 分辨率（pt） |
| -------------- | --------------------- | --------------- | ------------- | ------------ |
...
|   密度类型    | 分辨率（pt） | 屏幕密度（dpi） | 换算（rpx/pt） | 换算（pt/rpx） |  比例(rpx)   |
| ------------- | ------------ | --------------- | -------------- | -------------- | ------------ |
| iPhone 5s     | 320x568      | 332             | 1rpx=0.42pt    | 1pt=2.34rpx    | 749x1329     |
| **iPhone 6**  | 375x667      | 326             | 1rpx=0.5pt     | **1pt=2rpx**   | **750x1334** |
| iPhone 6 Plus | 414x736      | 401             | 1rpx=0.552pt   | 1pt=1.81rpx    | 749x1332     |
